...
const createNewAccount = async (req, res) => {
    var pool = await conn;
    var sqlString = "INSERT INTO NhanVien(HoTen, NgaySinh, DiaChi, DienThoai, GioiTinh, ChucVu, CCCD, Email, MaLuong, NgayBatDauLam) OUTPUT INSERTED.MaNhanVien VALUES (@HoTen, @NgaySinh, @DiaChi, @DienThoai, @GioiTinh, @ChucVu, @CCCD, @Email, @MaLuong, @NgayBatDauLam);";
    return pool.request()
        ...
        .query(sqlString, (err, data) => {
            ...
            var sqlStringTK = "INSERT INTO TaiKhoan(MaNhanVien, UserName, PassWord, Role) VALUES (@MaNhanVien, @UserName, @PassWord, @Role);";
            return pool.request()
